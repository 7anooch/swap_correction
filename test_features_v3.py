#!/usr/bin/env python3
"""
Test features_v3.py on the same data splits from stability_analysis_v3 iterations 007-012.

This script:
1. Loads trial splits from iterations 007-012
2. Uses features_v3.py for feature extraction (by patching imports)
...
def patch_features_module():
    """Patch the features module to use features_v3."""
    import swap_correction.ml.features.features_v3 as features_v3_module
    ...
    # Replace with v3
    features_module.extract_all_frame_features_optimized = features_v3_module.extract_all_frame_features_optimized
    
    # Also patch in submodules that import it
    try:
        import swap_correction.ml.training.train_model as train_module
        train_module.extract_all_frame_features_optimized = features_v3_module.extract_all_frame_features_optimized
    except:
        pass
    
    try:
        import swap_correction.ml.api.predictor as predictor_module
        predictor_module.extract_all_frame_features_optimized = features_v3_module.extract_all_frame_features_optimized
    except:
        pass
...
def main():
    ...
    print("=" * 80)
    print("TESTING features_v3.py ON STABILITY ANALYSIS SPLITS")
    print("=" * 80)
    ...
    print("Patching features module to use features_v3...")
    ...
    try:
        ...
        for iter_id in iteration_ids:
            ...
            for model_type in ['level1', 'raw']:
                ...
                try:
                    # [1/4] Prepare ML data
                    print(f"  [1/4] Preparing ML data with features_v3...")
                    ...
                    # Load training data (will use patched features_v3)
                    ...
                    # [4/4] Evaluate using the models we just trained (with features_v3)
                    ...
                    # Load the model we just trained (with features_v3)
                    ...
                    # Set the model components directly (these are the models we just trained with features_v3)
