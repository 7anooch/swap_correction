#!/usr/bin/env python3
"""
Generate stability report for features_v4 stability analysis.

This script aggregates results from stability_analysis_v3_features_v4
...
def load_features_v4_results(iteration_dirs):
    """Load results from features_v4 iteration directories."""
    all_results = []
...
def main():
    """Generate stability report for features_v4."""
    import json
    ...
    print("=" * 80)
    print("GENERATING STABILITY REPORT FOR FEATURES_V4")
    print("=" * 80)
    ...
    all_results = load_features_v4_results(iteration_dirs)
